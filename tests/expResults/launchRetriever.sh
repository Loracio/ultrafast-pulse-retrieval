...
/home/vloras/miniconda3/bin/python ./tests/expResults/plotExpResults.py $N $axisFilename $traceFilename $resultingFieldFilename $resultingSpectrumFilename $resultingTraceFilename $resultingErrorsFilename $centralWaveLength
